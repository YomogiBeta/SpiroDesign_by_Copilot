...
def rect(surface, color, rect, width=0, border_radius=0):
    ...
    if width:
        ...
        if border_radius:
            surface.strokeRoundRect(_rect.x, _rect.y, _rect.width, _rect.height, border_radius)
        else:
        ...
        if border_radius:
            surface.fillRoundRect(_rect.x, _rect.y, _rect.width, _rect.height, border_radius)
        else:
